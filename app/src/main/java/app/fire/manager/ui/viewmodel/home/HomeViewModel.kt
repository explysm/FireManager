package app.fire.manager.ui.viewmodel.home
...
import app.fire.manager.domain.manager.DownloadResult
...
import app.fire.manager.network.utils.CommitsPagingSource
import app.fire.manager.network.utils.dataOrNull
import app.fire.manager.network.utils.ifSuccessful
...
class HomeViewModel(
    ...
    private fun autoClearCache() {
        ...
        val latestVersion = when {
            prefs.discordVersion.isBlank() -> discordVersions?.get(DiscordVersion.Type.STABLE)
