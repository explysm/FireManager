...
import app.fire.manager.installer.util.ManifestPatcher
        ...
        arrayOf(baseApk, libsApk, langApk, resApk).forEach { apk ->
            ...
            ZipWriter(apk, true).use { zip ->
                ...
                val patchedManifestBytes = if (apk == baseApk) {
                    val customName = preferences.getInstanceName(preferences.packageName).ifBlank { app.fire.manager.BuildConfig.MOD_NAME }
