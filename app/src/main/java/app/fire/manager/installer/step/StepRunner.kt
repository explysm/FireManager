package app.fire.manager.installer.step
...
import app.fire.manager.installer.step.download.DownloadBaseStep
import app.fire.manager.installer.step.download.DownloadLangStep
import app.fire.manager.installer.step.download.DownloadLibsStep
import app.fire.manager.installer.step.download.DownloadResourcesStep
import app.fire.manager.installer.step.download.DownloadModStep
import app.fire.manager.installer.step.installing.InstallStep
import app.fire.manager.installer.step.patching.AddModStep
import app.fire.manager.installer.step.patching.PatchManifestsStep
import app.fire.manager.installer.step.patching.PresignApksStep
import app.fire.manager.installer.step.patching.ReplaceIconStep
import app.fire.manager.installer.util.LogEntry
import app.fire.manager.installer.util.Logger
