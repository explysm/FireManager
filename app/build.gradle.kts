...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "MOD_NAME", "\"FireCord\"")
        buildConfigField("String", "MANAGER_NAME", "\"Fire Manager\"")
        buildConfigField("String", "REPO", "\"explysm/FireCord\"")
        buildConfigField("String", "ORG_LINK", "\"https://github.com/explysm\"")
        buildConfigField("String", "INVITE_LINK", "\"sorry, we dont have a discord yet\"")
        buildConfigField("String", "MODDED_APP_PACKAGE_NAME", "\"app.fire.cord\"")
        buildConfigField("int", "MODDED_APP_ICON", "0xFFFF6600")
        buildConfigField("int", "MODDED_APP_ICON_ALPHA", "0xFFFFD700")
        buildConfigField("int", "MODDED_APP_ICON_OTHER", "0xFFDC143C")
